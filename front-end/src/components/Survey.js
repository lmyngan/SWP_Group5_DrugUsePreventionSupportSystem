    ...
    return (
        <div className="survey-box">
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <h2>1. In your life, which of the following substances have you ever used? (NON-MEDICAL USE ONLY)</h2>
                <hr /><br />

                <div className="survey-question">
                    <h3>Tobacco products (cigarettes, chewing tobacco, cigars, etc.)</h3>
                    <Form.Group>
                        <Form.Check
                            type="radio"
                            label="Yes"
                ...
                <div className="survey-question">
                    <h3>Alcoholic beverages (beer, wine, spirits, etc.)</h3>
                    <Form.Group>
                        <Form.Check
                            type="radio"
                            label="Yes"
                ...
                <div className="survey-question">
                    <h3>Cannabis (marijuana, pot, grass, hash, etc.)</h3>
                    <Form.Group>
                        <Form.Check
                            type="radio"
                            label="Yes"
                ...
                <div className="survey-question">
                    <h3>Amphetamine type stimulants (speed, meth, ecstasy, ice etc.)</h3>
                    <Form.Group>
                        <Form.Check
                            type="radio"
                            label="Yes"
                ...
                <div className="survey-question">
                    <h3>Inhalants (nitrous, glue, petrol, paint thinner, etc.)</h3>
                    <Form.Group>
                        <Form.Check
                            type="radio"
                            label="Yes"
                ...
                <div className="survey-question">
                    <h3>Sedatives or Sleeping Pills (diazepam, alprazolam, flunitrazepam, temazepam etc.)</h3>
                    <Form.Group>
                        <Form.Check
                            type="radio"
                            label="Yes"
                ...
                <div className="survey-question">
                    <h3>Hallucinogens (LSD, acid, mushrooms, trips, Ketamine, etc.)</h3>
                    <Form.Group>
                        <Form.Check
                            type="radio"
                            label="Yes"
                ...
                <div className="survey-question">
                    <h3>Opioids (heroin, morphine, methadone, opium, buprenorphine, codeine, etc.)</h3>
                    <Form.Group>
                        <Form.Check
                            type="radio"
                            label="Yes"
                ...
                <h2>2. In the past three months, how often have you used the substances you mentioned (FIRST DRUG, SECOND DRUG, ETC)?</h2>
                <hr /><br />
                ...
                <h2>3. Have you ever tried to cut down on using (FIRST DRUG, SECOND DRUG, ETC.) but failed?</h2>
                <hr /><br />
                ...
                <h2>4. Have you ever used any drug by injection? (NON-MEDICAL USE ONLY)</h2>
                <Form.Group>
                    <Form.Check
                        type="radio"
                        label="No, never"
